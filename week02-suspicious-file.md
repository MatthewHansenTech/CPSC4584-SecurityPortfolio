...
**File Type Finding:** patient_notes.txt: ELF 64-bit LSB executable, x86-64, dynamically linked, which means this is no longer a text file but instead an executable and linked format
